...
class Life {
    ...
    talentRandom() {
        return this.#talent.talentRandom(localStorage.extendTalent ? (JSON.parse(localStorage.extendTalent).length > 0 ? JSON.parse(localStorage.extendTalent) : null) : null);
    }
